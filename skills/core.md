...
Respect project context from AGENTS.md and .ai files.

If the task touches auth, payments, OAuth, user data, tokens, webhooks, or file uploads, mention security risks.

Prefer MVP and low-friction implementation. Do not overengineer.

Always include next actions or verification steps when useful.
